...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45,
    ...
    if args.display_fps:
        ...
        cv2.putText(img_numpy, fps_str, text_pt, font_face, font_scale, text_color,
    ...
    if args.display_text or args.display_bboxes:
        for j in reversed(range(num_dets_to_consider)):
            ...
            if args.display_text:
                ...
                text_w, text_h = \
                cv2.getTextSize(text_str, font_face, font_scale, font_thickness)[0]
...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    print(batch.shape)
    preds = net(batch)
    print(preds[0]['detection']['class'].shape)
    print(preds[0]['detection']['mask'].shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--display_fps', default=False, dest='display_fps',
                        action='store_true',
